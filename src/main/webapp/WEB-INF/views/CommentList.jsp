  ...
  <%@include file="headerBackground.jsp"%>
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
             ...
             <div class="col-lg-3">
              <div class="input-group"">
                <button type="button" class="btn btn-default"  data-toggle="modal" data-target="#myAddComment"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增評論</button>
              </div><!-- /input-group -->
            </div><!-- /.col-lg-6 -->
        </div>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <tr>
                  ...
                  <td>5</td>
                  <td>2016/11/02</td>
                  <th><button type="button" class="btn btn-success"  data-toggle="modal" data-target="#myModifyComment"><span class="glyphicon glyphicon-pencil" aria-hidden="true" ></span></button></th>
                  <th><button type="button" class="btn btn-danger"  data-toggle="modal" data-target="#mydeleteComment"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></th>
                </tr>
              </tbody>
            </table>
          </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="myModifyComment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="inputPassword3" placeholder="產品名稱" value="MacBook Pro">
                </div>
              </div>
              <div class="form-group">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">產品名稱</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="inputPassword3" placeholder="產品名稱" >
                </div>
              </div>
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">評論內容</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control comment-input" id="inputPassword3" placeholder="評論內容" >
                </div>
              </div>
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-2 control-label">評分</label>
    ...
    <div class="modal fade" id="mydeleteComment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
