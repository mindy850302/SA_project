...
<div id="wrapper2">
    <div id="welcome" class="container">
        ...
        <div class="content">
            ...
            <p>聯絡 Apple 授權維修中心以取得 iPhone 相關協助。在此之前，請先準備您的產品序號，以及您的 Apple ID 和密碼。</p>
            <h2 style="color:#333">親自送修</h2>
            <p>如需專人親自服務，請將您的產品帶到 Apple 授權維修中心。請務必在事前記得您的 Apple ID 和密碼。</p>
            <h2 style="color:#333">需要多少費用？</h2>
            <p>如果問題在保固或消費者保護法的範圍內，將不會收取任何費用。如果您的問題不在保固內，費用將視維修類型而定。如果我們無法維修您的 iPhone，可能會需要更換。</p>
            <h2 style="color:#333">需要多長時間？</h2>
            <p>您可能可以在線上查看維修狀態，實際則依取得維修的地點而定。</p>
            <h2 style="color:#333">Apple 有限保固範圍</h2>
            <p>Apple 有限保固涵蓋自產品購買日起一年內，iPhone 和 Apple 原廠配件的製造瑕疵。我們的保固額外附加於消費者保護法提供的權益。
我們的保固並未涵蓋意外損壞或擅自改裝。詳情請查看完整的保固詳細資料。您可以在線上檢查您的保固狀態，且可更新任何記錄出錯的購買證明資訊。</p>
           <h2 style="color:#333">超過保固期維修</h2>
            <p>我們會依據超過保固期的費用維修或更換您的產品。所更換的 iPhone 會是新品，或是效能與穩定性皆相當於新品的裝置。我們的保固額外附加於消費者保護法提供的權益。</p>
            <h2 style="color:#333">電池維修</h2>
            <p>Apple 有限保固涵蓋故障電池，但不包括正常使用造成的耗損。Apple 授權技術人員可能會需要測試您的產品，以便找出電池問題的原因。 如果您的電池有製造瑕疵且在我們的保固或消費者保護法的範圍內，Apple 授權維修中心將進行維修而不收取額外費用。如果您的 iPhone 電池不在保固範圍內，請和 Apple 授權維修中心洽詢超過保固期的電池維修。</p>
            <h2 style="color:#333">準備送修 iPhone</h2>
            <p>使用 iCloud 或 iTunes 將 iPhone 資料備份。如果我們必須重置或更換您的 iPhone，您將會需要備份來進行內容回復。
