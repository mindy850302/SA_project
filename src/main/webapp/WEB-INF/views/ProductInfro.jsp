    ...
    <%@include file="headerBackground.jsp"%>
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
             ...
             <div class="col-lg-3">
              <div class="input-group"">
                <button type="button" class="btn btn-default"  data-toggle="modal" data-target="#myAddProduct"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增產品</button>
              </div><!-- /input-group -->
            </div><!-- /.col-lg-6 -->
        </div>
          <ul class="nav nav-tabs" role="tablist" >
            <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab" style="color: #252830;">條列式</a></li>
            <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab" style="color: #252830;">區塊式</a></li>
          </ul>
            ...
            <table class="table table-striped table-show-product">
              ...
              <tbody>
                <tr>
                  ...
                  <td>2016/11/02</td>
                  <td>2016/11/02</td>
                  <td><button type="button" class="btn btn-success"  data-toggle="modal" data-target="#myModifyProduct"><span class="glyphicon glyphicon-pencil" aria-hidden="true" ></span></button></td>
                  <td><button type="button" class="btn btn-danger"  data-toggle="modal" data-target="#mydeleteProduct"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></td>
                </tr>
              </tbody>
            </table>
          </div>
