...
<!-- One -->
			<section id="one" class="wrapper spotlight style1">
				<div class="inner">
					<a href="#" class="image"><img src="img/iPad/iPadPro.jpg" alt="" /></a>
					<div class="content">
...
<!-- Two -->
			<section id="two" class="wrapper alt spotlight style2">
				<div class="inner">
					<a href="#" class="image"><img src="img/iPad/iPadAir2.jpg" alt="" /></a>
					<div class="content">
...
<!-- Three -->
			<section id="three" class="wrapper spotlight style3">
				<div class="inner">
					<a href="#" class="image"><img src="img/iPad/iPadMini4.jpg" alt="" /></a>
					<div class="content">
				...
				<div class="inner">
					...
					<section class="features">
						<article>
							...
							<p>更個人化，更強大，更有樂趣。</p>
							<p style="font-size: 5px">在 iOS 10 中，你喜歡做的一切事情都變得比以往更生動、更有趣、更具表現力。</p>
							<a href="#" class="special">Learn more</a>
						</article>
						<article>
							<a href="#" class="image"><img src="img/iPad/iPad_accessories.jpg" alt="" /></a>
							<h3 class="major">iPad 配件</h3>
							<p>出色的工具，協助你將 iPad 發揮得更淋漓盡致。</p>
							<a href="#" class="special">選購 iPad 配件</a>
						</article>
					</section>
				</div>
			</section>
