...
<nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/dashboard"><img src="img/tools.png"></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="/dashboard"><span class="glyphicon glyphicon-tasks" aria-hidden="true"></span>&nbspDashboard</a></li>
            <li class="dropdown">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li>
                <a href="#"><i class="fa fa-desktop "></i>會員管理 </a>
                 <ul class="nav nav-second-level">
                    <li>
                        <a href="/AccountList"><i class="fa fa-toggle-on"></i>成員列表</a>
                    </li>
                   <!--  <li>
            ...
            <li>
                <a href="/ProductInfro"><i class="fa fa-desktop "></i>產品列表</a>
                 <ul class="nav nav-second-level">
                    <!-- <li>
            ...
            <li><a href="/Inventory"><i class="fa fa-desktop "></i>存貨情況</a></li>
            <li><a href="/OrderDetail"><i class="fa fa-desktop "></i>訂單明細</a></li>
          </ul>
        </div>